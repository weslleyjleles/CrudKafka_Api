...
public class ConfiguracaoKafka {
    ...
    private <T> Map<String, Object> getPropriedades(Class<T> consumerTypeClass) {
    ...
    public ConcurrentKafkaListenerContainerFactory<Integer, Object> userContainerFactory() {
        ...
        factory.setConsumerFactory(new DefaultKafkaConsumerFactory<>(getPropriedades(usuarioMessage.class)));
    ...
    public ConcurrentKafkaListenerContainerFactory<Integer, Object> publishingContainerFactory() {
        ...
        factory.setConsumerFactory(new DefaultKafkaConsumerFactory<>(getPropriedades(PublishingMessage.class)));
        factory.getContainerProperties().setMissingTopicsFatal(false);
        factory.getContainerProperties().setSyncCommits(true);
